...
function ensureFilterTriggers($, $forms) {
  $forms.each(function () {
    ...
    const triggerMarkup = '<div class="custom-form__trigger" role="button" tabindex="0" aria-expanded="true">' + '<span class="custom-form__trigger-text">' + heading + "</span>" + '<span class="custom-form__chevron" aria-hidden="true"></span>' + "</div>";
